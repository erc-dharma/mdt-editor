...
(function() {
    ...
    const state = {
        ...
        template: '../templates/DHARMA_mdt_textTemplate_v01.xml',
        toplevel: 'textMetadataTemplate',
        savedtext: new Map(),
        saveInterval: null,
        autosaveprefix: 'ERC-DHARMA',
    };
    ...
    const editor = {
        ...
        hideEmpty: function() {
            ...
            const removelist = list.filter(m => {
                if(m.dataset.hasOwnProperty('required') && m.dataset.required === 'false') return true;
    ...
    const autosaved = {
        ...
        load: function(k,e) {
            ...
            lf.getItem(k).then(i => {
                ...
                state.filename = i.slice(state.autosaveprefix.length);
            });
        },
        ...
        save: function() {
            ...
            */
            ...
            lf.setItem(state.autosaveprefix+state.filename,xml.serialize(docclone)).then( function() {
